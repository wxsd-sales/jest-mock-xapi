...
- [httpClient-macro demo](./examples/httpClient-macro/README.md)
...
The script tries `wss://` for each address first, then retries with `ssh://`
if WSS fails. Test output uses the detected `SystemUnit ProductPlatform` value
